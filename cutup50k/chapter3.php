...
<head>
	...
	<title>&times; &#x34e; &ndash; Chapter Three</title>
...
<div class="container">
	...
	<article>
		<h3>Chapter Three</h3>
		<?php
		    $url = "http://www.theatlantic.com/magazine/archive/2013/11/the-man-who-would-teach-machines-to-think/309529/";
			$url = file_get_html("$url");
			$ret = $url->find('p');
			$ret = implode ($ret);
		    $returnMarkup = '';
		 		$lengthA = rand(3000,3800);
		 		$lengthB = rand(3350,3950);
		...
		?>
<cite>Text adapted from <em><a href="http://www.theatlantic.com/magazine/archive/2013/11/the-man-who-would-teach-machines-to-think/309529/">The Man Who Would Teach Machines to Think</a></em> by James Somers.</cite>
	</article>
	<nav>
		<ul>
			<li><a href="chapter2.php">&larr; Chapter Two</a></li>
			<li><a href="chapter4.php">Chapter Four &rarr;</a></li>
		</ul>
		<i class="clearfix"></i>
	</nav>
	<footer>
