...
<head>
	...
	<title>&times; &#x34e; &ndash; Chapter Five</title>
...
<div class="container">
	...
	<article>
		<h3>Chapter Five</h3>
		<?php
		    $url = "http://www.depauw.edu/sfs/backissues/68/wood68.html";
			$url = file_get_html("$url");
			$ret = $url->find('p');
			$ret = implode ($ret);
		    $returnMarkup = '';
		 		$lengthA = rand(1000,2000);
		 		$lengthB = rand(950,1350);
		...
		?>
		<cite>Text adapted from <em><a href="http://www.depauw.edu/sfs/backissues/68/wood68.html">William S. Burroughs and the Language of Cyberpunk</a></em> by Brent Wood.</cite>
			</article>
			<nav>
				<ul>
					<li><a href="chapter4.php">&larr; Chapter Four</a></li>
					<li><a href="chapter6.php">Chapter Six &rarr;</a></li>
				</ul>
				<i class="clearfix"></i>
			</nav>
			<footer>
