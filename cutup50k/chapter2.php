...
<head>
	...
	<title>&times; &#x34e; &ndash; Chapter Two</title>
...
<div class="container">
	...
	<article>
		<h3>Chapter Two</h3>
		<?php
		    $url = "http://www.texasmonthly.com/story/what-art?fullpage=1";
			$url = file_get_html("$url");
			$ret = $url->find('p');
			$ret = implode($ret);
		    $returnMarkup = '';
		 		$lengthA = rand(2800,3400);
		 		$lengthB = rand(3550,3950);
		...
		?>
		<cite>Text adapted from <em><a href="http://www.texasmonthly.com/story/what-art?fullpage=1">What Is Art?</a></em> by Francesca Mari.</cite>
	</article>
	<nav>
		<ul>
			<li><a href="index.php">&larr; Chapter One</a></li>
			<li><a href="chapter3.php">Chapter Three &rarr;</a></li>
		</ul>
		<i class="clearfix"></i>
	</nav>
	<footer>
