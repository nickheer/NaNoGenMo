...
<head>
	...
	<title>&times; &#x34e; &ndash; Chapter Six</title>
...
<div class="container">
	...
	<article>
		<h3>Chapter Six</h3>
		<?php
		    $url = "http://www.suburbia.net/~fun/scn/etc/wsb-dkahn.html";
			$url = file_get_html("$url");
			$ret = $url->find('p');
			$ret = implode ($ret);
		    $returnMarkup = '';
		 		$lengthA = rand(1000,2000);
		 		$lengthB = rand(780,1300);
		...
		?>
		<cite>Text adapted from <em><a href="http://www.suburbia.net/~fun/scn/etc/wsb-dkahn.html">Corporeal Communications Technologies in William S. Burroughs and L. Ron Hubbard</a></em> by Douglas Kahn.</cite>
			</article>
			<nav>
				<ul>
					<li><a href="chapter5.php">&larr; Chapter Five</a></li>
					<li><a href="chapter7.php">Chapter Seven &rarr;</a></li>
				</ul>
				<i class="clearfix"></i>
			</nav>
			<footer>
