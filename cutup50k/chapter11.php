...
<head>
	...
	<title>&times; &#x34e; &ndash; Chapter Eleven</title>
...
<div class="container">
	...
	<article>
		...
		<?php
		    $url = "http://www.newyorker.com/reporting/2012/03/26/120326fa_fact_seabrook?currentPage=all";
			$url = file_get_html("$url");
			$ret = $url->find('p');
			$ret = implode ($ret);
		    $returnMarkup = '';
		 		$lengthA = rand(2500,3500);
		 		$lengthB = rand(2150,3850);
		...
		?>
		<cite>Text adapted from <em><a href="http://www.newyorker.com/reporting/2012/03/26/120326fa_fact_seabrook?currentPage=all">The Song Machine</a></em> by John Seabrook.</cite>
			</article>
			<nav>
				<ul>
					<li><a href="chapter9.php">&larr; Chapter Nine</a></li>
					<li><a href="chapter11.php">Chapter Eleven &rarr;</a></li>
				</ul>
				<i class="clearfix"></i>
			</nav>
			<footer>
