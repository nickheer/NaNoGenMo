...
<head>
	...
	<title>&times; &#x34e; &ndash; Chapter Seven</title>
...
<div class="container">
	...
	<article>
		<h3>Chapter Seven</h3>
		<?php
		    $url = "http://pierretristam.com/Bobst/07/wf021407.htm";
			$url = file_get_html("$url");
			$ret = $url->find('p');
			$ret = implode ($ret);
		    $returnMarkup = '';
		 		$lengthA = rand(2000,3000);
		 		$lengthB = rand(1850,2150);
		...
		?>
		<cite>Text adapted from <em><a href="http://pierretristam.com/Bobst/07/wf021407.htm">Laissez-Faire Aesthetics</a></em> by Jed Perl.</cite>
			</article>
			<nav>
				<ul>
					<li><a href="chapter6.php">&larr; Chapter Six</a></li>
					<li><a href="chapter8.php">Chapter Eight &rarr;</a></li>
				</ul>
				<i class="clearfix"></i>
			</nav>
			<footer>
